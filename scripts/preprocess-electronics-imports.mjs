...
const sourceFile = "data/raw/us-census/imports/electronics/hs85-primary.csv";
...
const levels = [
  {
    ...
    codeLength: 2,
    codeField: "hsCode",
    outputFile: "electronics-imports-hs2.json",
    label: "HS2",
  },
  {
    id: "hs4",
    codeLength: 4,
    codeField: "hs4Code",
    outputFile: "electronics-imports-hs4.json",
    label: "HS4",
  },
  {
    id: "hs6",
    codeLength: 6,
    codeField: "hs6Code",
    outputFile: "electronics-imports-hs6.json",
    label: "HS6",
  },
  {
    id: "hs8",
    codeLength: 8,
    codeField: "hs8Code",
    outputFile: "electronics-imports-hs8.json",
    label: "HS8",
  },
];
...
function buildDataset({
  ...
  return {
    id: `electronics-imports-${level.id}-${slug}-${granularity}`,
    label: `${granularity === "monthly" ? "Monthly" : "Yearly"} electronics ${level.label} imports - ${country}`,
    country,
    sourceFile,
...
console.log(`Aggregated ${aggregatedTenDigitRows} electronics 10-digit HTS rows to HS8`);
console.log(`Skipped ${skippedRows} electronics rows with unsupported code lengths`);

...
const chartBasics: HelpSection = {
  ...
  bullets: [
    ...
    "Values are in US dollars unless the unit selector is set to % growth.",
    "% growth compares each month with the previous month, so it is best for spotting momentum rather than total size.",
    ...
    sections: [
      ...
      scopeBasics,
      {
        ...
        bullets: [
          ...
          "If a month is missing for a selected HS4 series, the chart fills it as zero so all selected scopes share the same time axis.",
        ],
      },
      chartBasics,
      linkBasics,
